...
#复位引脚
set_location_assignment	PIN_E15	-to iRSTn

#时钟引脚 50M
set_location_assignment	PIN_E1	-to iCLK 
...
#LED对应的引脚
set_location_assignment	PIN_G15	-to oLED[0]
set_location_assignment	PIN_F16	-to oLED[1]
set_location_assignment	PIN_F15	-to oLED[2]
set_location_assignment	PIN_D16	-to oLED[3]

#按键对应的引脚 KEY1已作为复位按键
#set_location_assignment	PIN_E15	 -to iKEY[0] # Used as iRSTn
set_location_assignment	PIN_E16	 -to iKEY[1]
set_location_assignment	PIN_M16  -to iKEY[2]
set_location_assignment	PIN_M15  -to iKEY[3]
...
#数码管7段+小数点
set_location_assignment	PIN_B7	-to oDigTubeValue[0]
set_location_assignment	PIN_A8	-to oDigTubeValue[1]
set_location_assignment	PIN_A6	-to oDigTubeValue[2]
set_location_assignment	PIN_B5	-to oDigTubeValue[3]
set_location_assignment	PIN_B6	-to oDigTubeValue[4]
set_location_assignment	PIN_A7	-to oDigTubeValue[5]
set_location_assignment	PIN_B8	-to oDigTubeValue[6]
set_location_assignment	PIN_A5	-to oDigTubeValue[7]

#6位数码管的6个控制位 片选开关
set_location_assignment	PIN_B1	-to oDigTubeSel[0]
set_location_assignment	PIN_A2	-to oDigTubeSel[1]
set_location_assignment	PIN_B3  -to oDigTubeSel[2]
set_location_assignment	PIN_A3	-to oDigTubeSel[3]
set_location_assignment	PIN_B4	-to oDigTubeSel[4]
set_location_assignment	PIN_A4	-to oDigTubeSel[5]
